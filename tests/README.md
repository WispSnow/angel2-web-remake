...
| 第 26 个可玩关卡（内部第 27 关）11–31 人部署、名单仅妮雅＋二十八候选、七名 NPC／三工兵名单外固定、槽 22 stableRemake 姓名“愛莉歐拉”／巨斧戰士通用肖像、SAY 51/52、五名叛军、四段妮雅线性到达区、无增援、当前 v95/v94/v93/v92 显示身份迁移与 stage 28 路由 | `stage27-content.test.ts`、`stage27-battle.test.ts`、`deployment.test.ts`、`deployment-session.test.ts`、`save.test.ts`、`stage-runtime.test.ts` | `stage27.spec.ts` |
