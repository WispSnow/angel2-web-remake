...
identityHash.update("stableRemake\0REMAKE-052\0");
...
const eventProgram = {
  ...
  reinforcementAudit,
  victory: {
    actor: { side: 1, slot: 7, name: "琴斯", portraitRecord: 14 },
  ...
  stableRemakeDecision: "REMAKE-052",
};
const deployment = {
...
const generatedSource = `// Generated by scripts/generate-stage20-runtime.mjs from stage 20 machine evidence.\n`
  ...
  + `export const STAGE20_KINS = ${json({ slot: 7, position: { x: 40, y: 16 }, name: kins.normalizedName, portraitRecord: kins.portraitRecord })} as const;\n`
