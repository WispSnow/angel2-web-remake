...
await Promise.all([
  ...
  copyFile(inputPaths.playerEntryMusic, path.join(publicAssetPath, "battle-stage33-player-entry.wav")),
  copyFile(inputPaths.playerLoopMusic, path.join(publicAssetPath, "battle-stage33-player-loop.wav")),
  copyFile(inputPaths.enemyEntryMusic, path.join(publicAssetPath, "battle-stage33-enemy-entry.wav")),
  copyFile(inputPaths.enemyLoopMusic, path.join(publicAssetPath, "battle-stage33-enemy-loop.wav")),
]);
