...
if (!objectiveText.includes("打敗敵人首領「蘭」") || !objectiveText.includes("「妮雅」戰敗")) {
  throw new Error("SAY/0084 no longer contains the stage 2 objective text");
}
