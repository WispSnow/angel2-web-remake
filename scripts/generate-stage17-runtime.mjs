...
await Promise.all([
  assertIdenticalImage(inputPaths.map, reversePath("renders/battle-maps/confirmed/14.png"), "stage 17 map"),
  assertIdenticalImage(inputPaths.minimap, reversePath("renders/battle-maps/minimap/14.png"), "stage 17 minimap"),
  removeDuplicateImage(path.join(publicAssetPath, "stage17-map.png")),
  removeDuplicateImage(path.join(publicAssetPath, "stage17-minimap.png")),
]);
