...
const [storySource, renderManifestSource] = await Promise.all([
...
const generatedSource = `// Generated by scripts/generate-portrait-catalog.mjs from D.SWF renders and native story metadata.\n`
...
console.log(`wrote ${copyOperations.length} portrait assets to ${path.relative(root, publicRoot)}`);
