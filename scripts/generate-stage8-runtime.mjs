...
const inputPaths = {
  ...
  omittedVictoryStory: reversePath("parsed/dialogue/0157.json"),
...
if (!originalObjectiveText.includes("打敗妖龍") || !originalObjectiveText.includes("「妮雅」戰敗")) {
  throw new Error("SAY/0090 objective conflict changed");
}
...
assertEqual(Object.values(storyPages).map((pages) => pages.length), [34, 2], "stage 8 story waits");
assertEqual(
...
const generatedSource = `// Generated by scripts/generate-stage8-runtime.mjs from stage 8 machine evidence.\n`
  ...
  + `  "stage-08-prebattle-story" | "stage-08-opening-story", readonly DialoguePage[]\n>>;\n`;
