...
await Promise.all([
  copyFile(inputPaths.map, path.join(publicAssetPath, "stage18-map.png")),
  copyFile(inputPaths.minimap, path.join(publicAssetPath, "stage18-minimap.png")),
  copyFile(inputPaths.playerEntryMusic, path.join(publicAssetPath, "battle-stage18-player-entry.wav")),
  copyFile(inputPaths.playerLoopMusic, path.join(publicAssetPath, "battle-stage18-player-loop.wav")),
  copyFile(inputPaths.enemyEntryMusic, path.join(publicAssetPath, "battle-stage18-enemy-entry.wav")),
  copyFile(inputPaths.enemyLoopMusic, path.join(publicAssetPath, "battle-stage18-enemy-loop.wav")),
]);
