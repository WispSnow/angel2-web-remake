...
await Promise.all([
  copyFile(inputPaths.map, path.join(publicAssetPath, "stage19-map.png")),
  copyFile(inputPaths.minimap, path.join(publicAssetPath, "stage19-minimap.png")),
  copyFile(inputPaths.playerEntryMusic, path.join(publicAssetPath, "battle-stage19-player-entry.wav")),
  copyFile(inputPaths.playerLoopMusic, path.join(publicAssetPath, "battle-stage19-player-loop.wav")),
  copyFile(inputPaths.enemyEntryMusic, path.join(publicAssetPath, "battle-stage19-enemy-entry.wav")),
  copyFile(inputPaths.enemyLoopMusic, path.join(publicAssetPath, "battle-stage19-enemy-loop.wav")),
]);
