...
const reinforcementSpecial = requireEntry(
  ...
  ({ stage }) => stage === 4,
  "stage 4 full-round reinforcements",
);
...
}, "stage 4 reinforcement invocation");
assertEqual(reinforcementSpecial, {
  ...
  spawnCells: [
    { cell: 73, hex: "0x0049", x: 23, y: 1 },
    { cell: 77, hex: "0x004D", x: 27, y: 1 },
  ],
...
const reinforcementCandidates = Array.from(
  ...
  (_, index) => {
    ...
    return {
      slot,
      nativeClassRecord: stageTemplate.classArrays.side2[slot],
      aiBehavior: stageTemplate.perSlotBehaviorArrays.side2[slot],
    };
  },
);
assertEqual(
  ...
  "stage 4 reinforcement candidate records",
);
const reinforcementProgram = {
  timing: "before-side-2-ai",
  spawnRounds: reinforcementSpecial.counter.resultingSpawnRounds,
  ...
  maximumSuccessfulSpawns: reinforcementSpecial.candidateSlots.maximumSuccessfulSpawns,
...
const generatedSource = `// Generated by scripts/generate-stage4-runtime.mjs from stage 4 machine evidence.\n`
  ...
  + `export const STAGE4_REINFORCEMENT_PROGRAM = ${json(reinforcementProgram)} as const;\n`
