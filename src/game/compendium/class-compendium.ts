...
const CLASS_NOTES: Readonly<Partial<Record<ClassId, readonly string[]>>> = {
  ...
  dragon: ["劇情首領：僅作為敵方登場，原版未提供 side 1 我方地圖模型。", "必定免疫普攻與法術附加的混亂狀態；可被施毒，每回合生命值減少三分之一。"],
  head: ["劇情首領：僅作為敵方登場，原版未提供 side 1 我方地圖模型。", "必定免疫普攻與法術附加的混亂狀態；可被施毒，每回合生命值減少三分之一。"],
  hand: ["劇情首領：僅作為敵方登場，原版未提供 side 1 我方地圖模型。", "必定免疫普攻與法術附加的混亂狀態；可被施毒，每回合生命值減少三分之一。"],
};
