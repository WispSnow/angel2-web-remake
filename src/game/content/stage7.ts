...
export const STAGE7_ASSETS = {
  ...
  audio: {
    story: "/assets/original/story-stage7.wav",
    playerEntry: "/assets/original/battle-stage7-player-entry.wav",
    playerLoop: "/assets/original/battle-stage7-player-loop.wav",
    enemyEntry: "/assets/original/battle-stage7-enemy-entry.wav",
    enemyLoop: "/assets/original/battle-stage7-enemy-loop.wav",
  },
} as const;
