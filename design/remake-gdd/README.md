...
阶段：内部第 30 关已获用户接受；第 30 个可玩关卡（内部第 31 关）“前往斯德林海峽”已实现并通过自动／视觉门禁；stage 32 及后续内容冻结
...
用户现已确认内部第 30 关测试通过，M57 转为接受。M58/M59 已按 `REMAKE-072` 闭合并实现
内部第 31 关的 5–17 人部署、十五敌伏击全灭、五通道无增援、v60/v59、调试入口与
stage 32 冻结路由；定向自动与代表性视觉门禁已验证，等待用户试玩。
...
| [`vertical-slices/stage-31.md`](vertical-slices/stage-31.md) | SAY 60/61/62、5–17 人部署、菲伊魯茵与十四名伏兵、全灭、无增援及 stage 32 冻结路由 | Draft 0.1 / 已验证，等待用户试玩 |
...
- 第 4、5 关已于 2026-08-08 获用户接受；第 6 关、`REMAKE-028` 与 v20 随后作为有界例外
  ...
  十五敌全灭与五通道无增援。该例外只覆盖本关合同；stage 32 及后续运行时继续冻结。
