...
阶段：内部第 32 关已获用户接受；第 32 个可玩关卡（内部第 33 关）“拉那洛城外”已实现并通过自动／视觉门禁；stage 34 及后续内容冻结
...
用户现已确认内部第 32 关测试通过，M61 转为接受。M62/M63 已按 `REMAKE-074` 闭合并实现
内部第 33 关的直接 1–10 人部署、二十九敌静态守军全灭、十五哨戒＋十四追击、五通道
无动态增援、无胜利 SAY、v62/v61、调试入口与 stage 34 冻结路由；定向自动与代表性
视觉门禁已验证，等待用户试玩。
...
| [`vertical-slices/stage-33.md`](vertical-slices/stage-33.md) | 直接 1–10 人部署、SAY 65、二十九名静态守军、十五哨戒＋十四追击、全灭、无动态增援、无胜利 SAY 及 stage 34 冻结路由 | Draft 0.1 / 已验证，等待用户试玩 |
...
- 第 4、5 关已于 2026-08-08 获用户接受；第 6 关、`REMAKE-028` 与 v20 随后作为有界例外
  ...
  ＋十四追击、五通道无动态增援与无胜利 SAY。该例外只覆盖本关合同；stage 34 及后续
  运行时继续冻结。
