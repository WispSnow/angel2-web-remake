...
阶段：内部第 35 关已获用户接受；第 35 个可玩关卡（内部第 36 关）“異世界的碧娜維姬”已实现并通过自动／视觉门禁；stage 37 及后续内容冻结
...
| [`vertical-slices/stage-36.md`](vertical-slices/stage-36.md) | 1–28 人部署、SAY 80、碧娜維姬与二十九名静态敌军、单首领目标、无动态增援及 stage 37 冻结路由 | Draft 0.1 / 已验证，等待用户试玩 |
...
- 第 4、5 关已于 2026-08-08 获用户接受；第 6 关、`REMAKE-028` 与 v20 随后作为有界例外
  ...
  加入双方共享专家 AI 同分集火；`REMAKE-080` 再把当前身份升级为 v67/v66，并以最大生命
  归一威胁耐久，使弩兵可正确集火低生命巫師。该例外只覆盖本关合同；
  stage 37 及后续运行时继续冻结。
