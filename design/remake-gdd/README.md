...
阶段：内部第 36 关已获用户接受；第 36 个可玩关卡（内部第 37 关）“究極女神”已实现并通过自动／视觉门禁；stage 49 主线结局链及后续内容冻结
...
技术菜单的禁咒候选及重复同名状态。M70/M71 随后按 `REMAKE-084` 闭合并实现内部
stage 37 的 1–27 人部署、究極女神三部位、专属交替术法、九字段隐藏、SAY/0081、
v71/v70 与 stage 49 主线结局冻结边界；定向自动与代表性视觉门禁已验证，等待用户试玩。
...
| [`vertical-slices/stage-37.md`](vertical-slices/stage-37.md) | 1–27 人部署、SAY 81、究極女神三部位、专属交替术法、九字段隐藏及 stage 49 主线结局边界 | Draft 0.1 / 已验证，等待用户试玩 |
...
- 第 4、5 关已于 2026-08-08 获用户接受；第 6 关、`REMAKE-028` 与 v20 随后作为有界例外
  ...
  M70/M71 再按 B/0075、SAY `81/105/154`、`REMAKE-084` 与 v71/v70 闭合并实现
  stage 37“究極女神”的 1–27 人部署、三个固定部位、专属交替术法、九字段隐藏、
  全灭目标与 stage 49 主线结局冻结边界。该例外只覆盖本关合同；stage 49 结局链、
  隐藏 stage 38 及后续运行时继续冻结。
