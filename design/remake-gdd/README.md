...
阶段：内部第 33 关已获用户接受；第 33 个可玩关卡（内部第 34 关）“拉那洛城內”已实现并通过自动／视觉门禁；stage 35 及后续内容冻结
...
用户现已确认内部第 33 关测试通过，M63 转为接受。M64/M65 已按 `REMAKE-075` 闭合并实现
内部第 34 关的直接 1–11 人部署、芙瑪羅妮／蕾娜吉芙与十七敌静态守军全灭、全员追击、
五通道无动态增援、无胜利 SAY、v63/v62、调试入口与 stage 35 冻结路由；定向自动与
代表性视觉门禁已验证，等待用户试玩。
...
| [`vertical-slices/stage-34.md`](vertical-slices/stage-34.md) | 直接 1–11 人部署、SAY 66、芙瑪羅妮／蕾娜吉芙与十七名静态守军、全员追击、全灭、无动态增援、无胜利 SAY 及 stage 35 冻结路由 | Draft 0.1 / 已验证，等待用户试玩 |
...
- 第 4、5 关已于 2026-08-08 获用户接受；第 6 关、`REMAKE-028` 与 v20 随后作为有界例外
  ...
  全员追击、五通道无动态增援与无胜利 SAY。该例外只覆盖本关合同；stage 35 及后续
  运行时继续冻结。
