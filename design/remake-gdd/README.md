...
阶段：内部第 31 关已获用户接受；第 31 个可玩关卡（内部第 32 关）“斯德林海峽”已实现并通过自动／视觉门禁；stage 33 及后续内容冻结
...
用户现已确认内部第 31 关测试通过，M59 转为接受。M60/M61 已按 `REMAKE-073` 闭合并实现
内部第 32 关的直接 1–16 人部署、十八敌静态联军全灭、五通道无动态增援、v61/v60、
调试入口与 stage 33 冻结路由；定向自动与代表性视觉门禁已验证，等待用户试玩。
...
| [`vertical-slices/stage-32.md`](vertical-slices/stage-32.md) | 直接 1–16 人部署、SAY 63/64、菲伊魯茵／芙瑪羅妮与十六名静态联军、全灭、无动态增援及 stage 33 冻结路由 | Draft 0.1 / 已验证，等待用户试玩 |
...
- 第 4、5 关已于 2026-08-08 获用户接受；第 6 关、`REMAKE-028` 与 v20 随后作为有界例外
  ...
  直接 1–16 人部署、十八敌静态联军全灭与五通道无动态增援。该例外只覆盖本关合同；
  stage 33 及后续运行时继续冻结。
