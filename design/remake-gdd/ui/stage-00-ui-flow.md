...
| `S00-UI-04a` | 系统菜单 | 玩家阶段中性态呼出 | 独立弹窗内显示胜利条件、集体命令入口和表现/声音控制；背景保留原右栏焦点态 | 导航/主操作选择；副操作返回 | 返回原战场、打开目标或集体命令 |
...
| `S00-UI-06a` | 集体命令/撤退确认 | 玩家阶段中性态呼出 | “全部休息／跟随主将／自由行动／全面撤退”；跟随主将要求焦点位于尚未行动的我方单位；撤退使用原文确认 | 导航、主操作确认、副操作取消 | 我方自动阶段、重建本关或返回战场 |
