...
const CODE_SIGNATURES = [
  ...
  ["1000:6084", 294, "lightning-4-presentation-and-descending-anchor", "4b03c3c85f08903863f318a4a8bb2237708bd3775a2cfa9161d61c79f6a1878f"],
  ...
  ["1000:67C1", 83, "ice-expansion-cycles-inner-to-outer", "6212a8955c43281f91f4685d12b00b372b0427d55d83eb13afc15ceb7f8ac89b"],
  ["1000:6814", 114, "ice-range-stage-and-ring-draw", "0d329434638cf643fa3905f6bcb34857acf1741b2602c0789b8af3c3b86f8aa7"],
  ...
  const ice = {
    ...
    actions: [3, 4, 5, 6].map((effectRadius, index) => {
      ...
      return {
        ...
        effectRadius,
        cycles,
        rangeValueSequence: Array.from({ length: cycles }, (_, cycle) => cycles - cycle),
        distanceFromCenterSequence: Array.from({ length: cycles }, (_, cycle) => cycle + 1),
      ...
      },
      {
        ...
        phases: [
          stage(buffer, "MAGIC/39", Array.from({ length: 9 }, () => [0x6428, 0x6412]).flat(), 3, {
            anchorOffsetSequence: Array.from({ length: 18 }, (_, index) => ({
              x: 0,
          ...
          stage(buffer, "MAGIC/39", [0x643e, 0x6454, 0x646a, 0x6480], 10, {
            anchorOffsetSequence: Array.from({ length: 4 }, () => ({ x: 0, y: 1 })),
          }),
          stage(buffer, "MAGIC/40", [0x64b2, 0x64e4, 0x6516, 0x64b2, 0x64e4, 0x6516], 10, {
            anchorOffsetSequence: Array.from({ length: 6 }, () => ({ x: 0, y: 1 })),
          }),
          stage(buffer, "MAGIC/39", [0x6480, 0x646a, 0x6454, 0x643e], 10, {
            anchorOffsetSequence: Array.from({ length: 4 }, () => ({ x: 0, y: 1 })),
            direction: "reverse",
          }),
        ],
