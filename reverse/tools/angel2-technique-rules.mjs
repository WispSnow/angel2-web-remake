...
const CODE_SIGNATURES = [
  ...
  { address: "0000:7277", offset: 0x7277, hex: "ba1400e86600b91e0003c8a1c1779a0c004717ba0400e8530083c108e86900c3" },
  { address: "0000:7297", offset: 0x7297, hex: "ba1400e84600b9460003c8a1c1779a0c004717ba0500e8330083c10de84900c3" },
  { address: "0000:72B7", offset: 0x72b7, hex: "c706181f0600c7060f1f32009a04009d13ba1400e81500b9320003c8e8ce59ba0500e8070083c10de81d00c3" },
  { address: "0000:72E3", offset: 0x72e3, hex: "2e8a26fe72e44002c4b4003bc272072e2816fe72ebea2ea2fe72c3" },
  { address: "0000:CCA4", offset: 0xcca4, hex: "518b36bf778b3ec1779a2900de179aac009d1359c706181f0600a1c1779a06004a16ba0500e83e0303c883c10dc3" },
  { address: "1747:0086", offset: 0x174f6, hex: "9acf6300008bc8cb" },
  { address: "164A:0047", offset: 0x164ed, hex: "9acf6300008bc8cb" },
  ...
  { address: "0000:CB0B", offset: 0xcb0b, hex: "a1c177b91400c706181f03009a0200db15ba0200e8e80403c883c108c3" },
  { address: "0000:CB28", offset: 0xcb28, hex: "a1c177b91400c706181f04009a0000e815ba0200e8cb0403c883c10ac3" },
  { address: "0000:CB45", offset: 0xcb45, hex: "a1c177b91400c706181f04009a0200f615ba0300e8ae0403c883c10cc3" },
  { address: "0000:CB62", offset: 0xcb62, hex: "a1c177b91400c706181f05009a04000816ba0300e8910403c883c10fc3" },
  ...
  { address: "0000:72FF", offset: 0x72ff, hex: "518b1ebf77900ee84fdd599a7d01b618c3" },
  { address: "0000:D00A", offset: 0xd00a, hex: "2e8a2625d0e44002c4b4003bc272072e281625d0ebea2ea225d0c3" },
  { address: "1000:8CDD", offset: 0x18cdd, hex: "8b36b9318b440203c1894402" },
  ...
  return {
    ...
    families: {
      L: {
        ...
        tiers: [
          { code: "1L", selectionRadius: 4, effectRadius: 3, damageByRangeValue: { 1: 20, 2: 35, 3: 50 }, experienceBase: 8, experienceRandom: [0, 1] },
          { code: "2L", selectionRadius: 5, effectRadius: 4, damageByRangeValue: { 1: 15, 2: 30, 3: 45, 4: 60 }, experienceBase: 10, experienceRandom: [0, 1] },
          { code: "3L", selectionRadius: 6, effectRadius: 4, damageByRangeValue: { 1: 45, 2: 60, 3: 75, 4: 90 }, experienceBase: 12, experienceRandom: [0, 2] },
          { code: "4L", selectionRadius: 7, effectRadius: 5, damageByRangeValue: { 1: 30, 2: 50, 3: 70, 4: 90, 5: 110 }, experienceBase: 15, experienceRandom: [0, 2] },
        ],
        ...
        experience: "the 1000:7166 inner effect returns all kill rewards in CX; each CB0B/CB28/CB45/CB62 outer wrapper then unconditionally adds tier base + randomBelow(2/2/3/3), and 0000:72FF commits the total through 1000:8CDD",
      },
      F: {
        visibleName: "炎暴",
...
function shootingRules(descriptorsByCode) {
  return {
    ...
    classes: [
      { classCode: "3A", descriptorMatches: descriptorsByCode.get("3A") ?? [], maximumRange: 5, damage: "30..49 to selected target", experience: "kill reward + 8 flat (0000:7290 has no add cx,ax, so the DX=4 roll is discarded; CX still holds the death-scan total from 1747:000C+7A)" },
      { classCode: "0I", descriptorMatches: descriptorsByCode.get("0I") ?? [], maximumRange: 8, damage: "70..89 to selected target", experience: "kill reward + 13 flat (0000:72B0, same shape as 3A, discarding the DX=5 roll)" },
      { classCode: "1I", descriptorMatches: descriptorsByCode.get("1I") ?? [], maximumRange: 6, damage: "roll 50..69; selected target receives 2*floor(roll/2)=50..68, while other eligible occupied line cells receive floor(roll/2)=25..34", experience: "kill reward + 26..30 (3V handler 0000:CCA4 returns kill + randomBelow(5) + 13; 0000:72DC adds a second 13)" },
    ],
    swiftDragonEvasion: {
      targetClassCode: "0E",
