  ...
  return {
    ...
    families: {
      ...
      C: {
        ...
        tiers: [
          { code: "1C", selectionRadius: 2, effectRadius: 3, experienceBase: 8, experienceRandom: [0, 1] },
          { code: "2C", selectionRadius: 3, effectRadius: 4, experienceBase: 10, experienceRandom: [0, 1] },
          { code: "3C", selectionRadius: 3, effectRadius: 5, experienceBase: 12, experienceRandom: [0, 2] },
          { code: "4C", selectionRadius: 4, effectRadius: 6, experienceBase: 15, experienceRandom: [0, 2] },
        ],
