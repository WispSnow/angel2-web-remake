...
| M16 | 第 9 关有界实现 | `verified` | 证据生成内容、2–9 人部署、多莉独立路线、十四名敌军、v30、Chromium 与视觉门禁通过 |
...
十四名敌军、v30 与非连续 stage 11 路由；定向自动与视觉门禁通过，等待用户试玩。
...
M14/M14.10 第 8 关已获用户接受；M15/M16 第 9 关纸面合同与有界实现已完成自动及视觉
门禁，等待用户试玩。第 11 关及后续内容仍需独立纸面合同和用户授权。
