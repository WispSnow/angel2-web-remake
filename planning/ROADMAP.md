...
| M20 | 内部第 10 关有界实现 | `verified` | SAY 28、部署、五名追兵、v33/v32、Chromium 与视觉门禁通过，等待用户试玩 |
...
自动、Chromium、视觉、构建和文档门禁通过，等待用户试玩。
...
内部第 10 关已完成纸面、自动及视觉门禁，等待用户试玩。stage 12 及后续内容仍需独立
纸面合同和用户授权。
