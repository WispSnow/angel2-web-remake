...
| M22 | 内部第 12 关有界实现 | `verified` | SAY 29–31、BK/10–14、水戰士正式战役分裂、v34/v33、调试与自动／视觉门禁通过，待用户试玩 |
...
自动、Chromium、视觉、构建、证据和文档门禁已通过，等待用户试玩。
...
内部第 10 关已获用户接受；内部第 12 关已验证、等待用户试玩。stage 13 及后续内容仍需
独立纸面合同和用户授权。
