...
| M14.8 | 冰雪反制与巫師仇恨 | `verified` | `REMAKE-036` 外圈外推、巫師第二优先级带及 v27/v26 迁移通过定向门禁 |
...
M14 第 8 关已获用户接受；原版普通近战与法师系技术 AI 优先级已完成机器复核，M14.5
专家敌方 AI 已按独立产品决策验证。第 9 关仍需独立纸面合同和用户授权，不因系统改造
而自动解冻。
