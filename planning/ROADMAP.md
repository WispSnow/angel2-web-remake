...
| M24 | 内部第 13 关有界实现 | `verified` | SAY 32、瑪西爾目标、v35/v34、调试与自动／视觉门禁通过，待用户试玩 |
...
stage 14 冻结路由；自动、Chromium、视觉、构建、证据和文档门禁已通过，等待用户试玩。
...
内部第 10、12 关已获用户接受；内部第 13 关已验证、等待用户试玩。stage 14 及后续内容仍需
独立纸面合同和用户授权。
