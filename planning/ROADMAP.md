...
| M18 | 内部第 11 关有界实现 | `verified` | 八名玩家单位、飞马追兵／无限可复用增援、SAY 24–27、v32、Chromium 与视觉门禁通过 |
...
M14/M14.10 第 8 关与 M15/M16 第 9 关均获用户接受；M17/M18 内部第 11 关已完成纸面、
自动及视觉门禁，等待用户试玩。内部第 10 关及后续内容仍需独立纸面合同和用户授权。
