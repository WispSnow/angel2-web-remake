...
| M51 | 内部第 27 关有界实现 | `verified` | 证据生成、混合控制军团、SAY 51/52、v51/v50、调试、stage 28 路由及定向自动／视觉／构建／文档门禁通过，待用户试玩 |
...
独立城防友军、五名静态叛军、无增援、四段妮雅线性到达区、v51/v50 与 stage 28 冻结
...
第 0–24 关、内部第 26 关与既有非连续战斗均获用户接受；内部第 27 关已获授权并完成有界
实现主体。stage 28 及后续内容仍需独立纸面合同和用户授权，内部场景 25 不自行补造。
