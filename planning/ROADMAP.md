...
| M43 | 内部第 22 关有界实现 | `verified` | 证据生成、首回合伏击、v44/v43、调试与自动／视觉门禁通过，待用户试玩 |
...
剧情、六敌伏击、妖龍单一目标、v44/v43 与 stage 23 冻结路由；定向自动、生产构建与
五张代表性截图视觉门禁通过，等待用户从普通入口试玩。
...
第 0–21 关与既有非连续战斗均获用户接受；内部第 22 关已通过自动验收、等待用户试玩。
stage 23 及后续内容仍需独立纸面合同和用户授权。
