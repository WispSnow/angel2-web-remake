...
| M03 | 第 2 关实现 | `verified` | 固定阵容、友军自动阶段、首领目标、续关存档与 stage 3 边界；等待人工接受 |
...
原版双方音乐、v13 战中恢复／入关快照及 `stage-03` 明确边界。实现与自动门禁已完成，当前等待
用户从普通入口人工验收；第 3 关及其新职业/技术继续冻结。

## 后续能力切片

第 2 关被接受后，再按原战役中首次正常可达的能力选择切片：
