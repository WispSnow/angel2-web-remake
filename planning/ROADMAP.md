...
| M14.9 | 双方共享自动行动专家 AI | `accepted` | `REMAKE-037/060/065/066/079/080/081/082/083` 统一双方规划器并补完整通路、法系落点、远程职责、单体预计残血集火、独立职业目标优先级及控制目标状态边界；系统基线 v70/v69，当前全局 v73 |
...
身份升级为 v70 / `expert-control-targeting-ai-1`，v69 无损迁移；当前全局身份为 v73。
