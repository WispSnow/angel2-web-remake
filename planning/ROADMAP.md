...
| M10 | 第 6 关有界实现 | `implemented` | 第 6 关、动态游骑兵台阵、v20、调试和定向自动／视觉验收完成，等待用户试玩接受 |
...
Chromium、调试目录、生产构建与代表性视觉审计完成；当前等待用户人工接受。
...
当前人工门槛是第 6 关试玩。第 7 关仍需独立纸面合同和用户授权；不得因第 6 关完成而
提前实现。
